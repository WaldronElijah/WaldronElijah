...
- Connecting AI powered tools with interactive learning experiences
- Exploring better ways to make technical education more dynamic
...
### Sports Data Workflows
- Sports data engineering
- Analytics workflows
- Data collection and transformation systems

### Product and App Design
- Product design for user friendly software
- Rich media app experiences
- Better ways to organize visual and embedded content
